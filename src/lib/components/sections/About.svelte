          ...
          {#each board as person (person.name)}
            <div class="flex items-center gap-4 py-4 border-b border-gray-100 last:border-b-0">
              ...
              <div class="min-w-0 grow">
                <p class="font-semibold text-primary text-base mb-0 leading-snug">{person.name}</p>
                <p class="text-sm text-gray-400 mb-0">{person.role}</p>
              </div>
              <a href={person.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="shrink-0 text-gray-300 hover:text-primary no-underline">
          ...
          {#each ['Lokalizować, współtworzyć standardy i certyfikację w obszarach dot. jakości w IT.', 'Edukować, promować jakość, prowadzić działalność ekspercką w tym zakresie.', 'Nawiązywać i rozwijać międzynarodowe relacje z innymi organizacjami i osobami w celu promocji polskiego IT.', 'Udostępniać i współpracować nad technologiami, szczególnie tymi, które niosą jakościowe ryzyka.'] as item, i (i)}
            <li class="flex items-start gap-3">
              <span class="relative flex w-2.5 h-2.5 shrink-0 mt-1 items-center justify-center">
                <span class="ping-soft absolute inline-flex h-full w-full rounded-full bg-accent opacity-75"></span>

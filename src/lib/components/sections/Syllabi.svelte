<script>
  ...
  let sorts = $state({ FL: { key: 'default', dir: 'asc' }, TA: { key: 'default', dir: 'asc' }, TM: { key: 'default', dir: 'asc' } });
  ...
  const certifications = [
    {
      ...
      title: 'Certyfikowany Tester / Poziom Podstawowy',
      version: 'v4.0.1',
      documents: [
        { name: 'Sylabus',             lang: 'PL', type: 'syllabus',  file: 'fl-4.0.1/FL-4.0.1-PL-sylabus.pdf' },
        { name: 'Pytania – zestaw A',  lang: 'PL', type: 'questions', file: 'fl-4.0.1/FL-4.0.1-PL-zestaw-A-pytania-v1.7.pdf' },
        { name: 'Odpowiedzi – zestaw A', lang: 'PL', type: 'answers', file: 'fl-4.0.1/FL-4.0.1-PL-zestaw-A-odpowiedzi-v1.7.pdf' },
        { name: 'Pytania – zestaw B',  lang: 'PL', type: 'questions', file: 'fl-4.0.1/FL-4.0.1-PL-zestaw-B-pytania-v1.7.pdf' },
        { name: 'Odpowiedzi – zestaw B', lang: 'PL', type: 'answers', file: 'fl-4.0.1/FL-4.0.1-PL-zestaw-B-odpowiedzi-v1.7.pdf' },
        { name: 'Pytania – zestaw C',  lang: 'PL', type: 'questions', file: 'fl-4.0.1/FL-4.0.1-PL-zestaw-C-pytania-v1.6.pdf' },
        { name: 'Odpowiedzi – zestaw C', lang: 'PL', type: 'answers', file: 'fl-4.0.1/FL-4.0.1-PL-zestaw-C-odpowiedzi-v1.6.pdf' },
        { name: 'Pytania – zestaw D',  lang: 'PL', type: 'questions', file: 'fl-4.0.1/FL-4.0.1-PL-zestaw-D-pytania-v1.5.pdf' },
        { name: 'Odpowiedzi – zestaw D', lang: 'PL', type: 'answers', file: 'fl-4.0.1/FL-4.0.1-PL-zestaw-D-odpowiedzi-v1.5.pdf' },
        { name: 'Wytyczne do akredytacji', lang: 'PL', type: 'guide', file: 'fl-4.0.1/FL-4.0.1-PL-wytyczne-do-akredytacji-v0.3.pdf' },
      ],
    },
    {
      code: 'TA',
      badge: 'Poziom Zaawansowany',
      title: 'Certyfikowany Tester / Poziom Zaawansowany / Analityk Testów',
      version: 'v4.0',
      documents: [
    ...
    },
    {
      code: 'TM',
      badge: 'Poziom Zaawansowany',
      title: 'Certyfikowany Tester / Poziom Zaawansowany / Zarządzanie Testami',
      version: 'v3.0',
      documents: [
        { name: 'Sylabus',                lang: 'PL', type: 'syllabus',  file: 'tm-3.0/TM-3.0-PL-sylabus.pdf' },
        { name: 'Pytania',                lang: 'PL', type: 'questions', file: 'tm-3.0/TM-3.0-PL-pytania-v1.3.3.pdf' },
        { name: 'Odpowiedzi',             lang: 'PL', type: 'answers',   file: 'tm-3.0/TM-3.0-PL-odpowiedzi-v1.3.3.pdf' },
        { name: 'Wytyczne do akredytacji', lang: 'PL', type: 'guide',   file: 'tm-3.0/TM-3.0-PL-wytyczne-do-akredytacji-v1.0.pdf' },
      ],
    },
  ];
</script>
                ...
                {#each sortDocs(cert.code, cert.documents) as doc, i (doc.file)}
                  <tr class="border-b border-gray-100 last:border-b-0 {i % 2 !== 0 ? 'bg-gray-50/50' : 'bg-white'}">
                    ...
                    <td class="px-4 py-3.5 text-center">
                      <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-[11px] font-semibold {typeStyles[doc.type].pill}">
